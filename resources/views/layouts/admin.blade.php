...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block">
                <a href="{{url('/')}}" class="nav-link">Control Electoral</a>
            </li>
        </ul>
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{url('/admin/delegados')}}" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    <li class="nav-item">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                               <a href="{{url('/admin/delegados/reporte-agrupacion')}}" class="nav-link active">
                                <i class="far fa-circle nav-icon"></i>
 ...
 <!-- .content-wrapper -->
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2025 <a href="https://www.facebook.com/insignia.Tja">Insignia</a>.</strong> Todos los derechos reservados.
    </footer>
</div>
<!-- ./wrapper -->
